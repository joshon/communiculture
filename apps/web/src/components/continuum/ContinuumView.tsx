...
export function ContinuumView({ continuum, participants, messages, sessionToken, currentUserAvatarConfig }: Props) {
  ...
  // Imperatively position / show / hide the pre-join bar div from the canvas animation loop
  const onBarFracUpdate = useCallback((frac: number) => {
